...
export default function Hero() {
  return (
    <section className="w-full bg-[var(--left)]">
      <div className="grid w-full md:grid-cols-2 min-h-[420px] md:min-h-[520px]">
        <div className="bg-[var(--left)]">
          <div className="mx-auto w-full max-w-[1200px] px-6 md:px-24 h-full">
            <div className="pt-10 pb-10 md:pt-20 md:pb-24 flex flex-col justify-center h-full">
              <div className="w-full max-w-[760px] mx-auto md:mx-0 text-center md:text-left">
        ...
        <div className="relative bg-[var(--brand)] md:rounded-bl-[60px]">
          <div className="mx-auto w-full max-w-[1200px] px-6 md:px-24">
            <div className="relative h-[420px] sm:h-[460px] md:h-full py-10 md:py-20">
              <div className="relative h-full">
                <div className="absolute left-[38px] top-[90px] md:left-[80px] md:top-[120px] grid h-16 w-16 -rotate-6 place-items-center rounded-2xl bg-white shadow-sm">
                  <Image
                ...
                <div className="absolute right-[38px] top-[140px] md:right-[90px] md:top-[200px] grid h-16 w-16 rotate-6 place-items-center rounded-2xl bg-white shadow-sm">
                  <Image
                ...
                <div className="absolute left-[38px] top-[250px] md:left-[85px] md:top-[330px] grid h-16 w-16 -rotate-3 place-items-center rounded-2xl bg-white shadow-sm">
                  <Image
